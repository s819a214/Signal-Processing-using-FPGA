...
set_property PACKAGE_PIN V7 [get_ports {count_out[4]}]
set_property PACKAGE_PIN V6 [get_ports {count_out[3]}]
set_property PACKAGE_PIN U9 [get_ports {count_out[2]}]
set_property PACKAGE_PIN R7 [get_ports {count_out[1]}]
set_property PACKAGE_PIN U8 [get_ports {count_out[0]}]
set_property PACKAGE_PIN E3 [get_ports clk]
set_property PACKAGE_PIN R5 [get_ports clk_out]
